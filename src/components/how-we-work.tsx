...
<div className="lg:px-36 lg:py-16 md:px-24 md:py-16 px-[20px] py-[20px] bg-[#F5F8FF] w-full" id="about">
            <div className="flex gap-8 flex-col items-center justify-center lg:grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 w-full">
                <div className="">
                  <h2 className="sm:pt-4 text-[#00012D] text-[24px] lg:text-left text-center  lg:text-[40px]  font-bold leading-normal">
                  Why Africa for Your BPO Needs?
                  </h2>
                  <h2 className="sm:pt-4 text-[#00012D] text-[18px] lg:text-left text-center  lg:text-[24px]  font-bold leading-normal">
...
<div className="">
     <h4 className="text-[#595959] font-bold text-[18px] lg:text-left text-center lg:text-[18px]  mt-4 mb-8 leading-[30px] lg:w-4/5 w-full">
                  Key Statistics
                  </h4>
          ...
          <div className="lg:px-36 lg:py-16 md:px-24 md:py-16 px-[20px] py-[20px] bg-[#F5F8FF] w-full" id="about">
            ...
            <div className="sm:px-[20px] ">
              <img src={Image.work2}  alt="logo" className="lg:w-full lg:h-[400px] md:w-full md:h-[400px] md:object-cover lg:object-cover rounded-[30px]"/> 
               ...
               <div className="">
               <h2 className="sm:pt-4 text-[#00012D] text-[24px] lg:text-left text-center  lg:text-[40px]  font-bold leading-normal">
                   GetGlobal’s BPO Support Package
                  </h2>
                  <h2 className="sm:pt-4 text-[#00012D] text-[18px] lg:text-left text-center  lg:text-[24px]  font-bold leading-normal">
       ...
       <a href="https://calendly.com/gideon-ibeabuchi-telesoftas/30min" target="_blank" className="flex  lg:items-center lg:justify-start md:items-center md:justify-start sm:items-center sm:justify-center ">
          ...
          <div className="lg:px-36 lg:py-16 md:px-24 md:py-16 px-[20px] py-[20px] bg-[#F5F8FF] w-full" id="about">
            <div className="flex gap-8 flex-col items-center justify-center lg:grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 w-full">
                <div className="">
                <h2 className="sm:pt-4 text-[#00012D] text-[24px] lg:text-left text-center  lg:text-[40px]  font-bold leading-normal">
                  The Talent Refinery – Bridging the Skills Gap
                  </h2>
                  <h2 className="sm:pt-4 text-[#00012D] text-[18px] lg:text-left text-center  lg:text-[24px]  font-bold leading-normal">
