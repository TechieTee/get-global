...
<div className="lg:px-36 lg:py-16 md:px-24 md:py-16 px-[20px] py-[20px] bg-[#F5F8FF] w-full" id="about">
            <div className="flex flex-col items-center justify-center lg:grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 w-full">
                <div className="">
                  ...
                  <h2 className="sm:pt-4 text-[#00012D] text-2xl lg:text-left text-center  lg:text-4xl  font-bold leading-normal">
                  ...
                  <h4 className="text-[#595959] font-bold text-[18px] lg:text-left text-center lg:text-[18px] font-normal mt-4 mb-8 leading-[30px] lg:w-4/5 w-full">
                  Key Statistics
                  </h4>
